...
source <(wget -qO- https://raw.githubusercontent.com/iamnhx/Bash-Scripts/master/Seedbox%20Provisioning/Miscellaneous/tput.sh)
...
source <(wget -qO- https://raw.githubusercontent.com/iamnhx/Bash-Scripts/master/Seedbox%20Provisioning/seedbox_installation.sh)
Update
...
source <(wget -qO- https://raw.githubusercontent.com/iamnhx/Bash-Scripts/master/Seedbox%20Provisioning/tweaks.sh)
CPU_Tweaking
NIC_Tweaking
...
wget https://raw.githubusercontent.com/iamnhx/Bash-Scripts/master/Seedbox%20Provisioning/Miscellaneous/.boot-script.sh && chmod +x .boot-script.sh
